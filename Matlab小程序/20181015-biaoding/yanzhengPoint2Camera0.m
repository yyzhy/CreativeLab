...
%PT0_0 = load('./pointCloud0/ptCloud00.asc');
%PT0_1 = load('./pointCloud0/ptCloud01.asc');
PT0_2 = load('./pointCloud0/ptCloud02.asc');
%PT0_3 = load('./pointCloud0/ptCloud03.asc');
...
fid = fopen('./pointCloud0/Camera0-ptCloud02.asc', 'w');
for j = 1 : M2
    % 重建出来的点
    XW = PT0_2(j,1:3);
    % 换算回相机坐标系
